export const ZONES = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    metaDesc: 'Empresa de reformas en Torrejón de Ardoz. Precio cerrado y coordinación completa para toda la obra. Visita técnica gratuita y presupuesto por escrito.',
    primary: true,
    province: 'Madrid',
    desc: 'Municipio de referencia en el Corredor. Precio cerrado, presupuesto gratuito.',
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    primary: true,
    province: 'Madrid',
    desc: 'Reformas en Coslada con profesionales de confianza. Presupuesto gratuito.',
