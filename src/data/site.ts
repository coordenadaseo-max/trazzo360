...
export const ZONES = [
  ...
  { slug: 'meco', name: 'Meco', primary: false, desc: 'Cubrimos Meco y municipios próximos.' },
  { slug: 'camarma-de-esteruelas', name: 'Camarma de Esteruelas', primary: false, desc: 'Reformas en Camarma de Esteruelas.' },
];
