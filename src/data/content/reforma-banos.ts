...
export const CONTENT: Record<string, { intro: string; intersectionThesis?: string; body: { type: string; text: string; link?: { text: string; serviceSlug: string } }[] }> = {
  ...
  'alcala-de-henares': {
    ...
    body: [
      ...
      { type: 'p', text: 'En barrios como El Chorrillo, Nueva Alcalá o Reyes Católicos, las viviendas son más recientes y las instalaciones pueden estar en mejor estado. Allí la reforma puede centrarse en cambiar el alicatado, los sanitarios y el mueble sin necesidad de tocar la fontanería. La diferencia de presupuesto entre los dos escenarios puede ser de varios miles de euros, y determinarla en la visita evita sorpresas.' },
      ...
      { type: 'p', text: 'En el centro histórico y en portales sin ascensor, el transporte de escombros se organiza en turnos para no bloquear el acceso durante toda la jornada. La solicitud del contenedor en vía pública ante el Ayuntamiento requiere tramitación previa cuyo plazo se confirma al presentar la solicitud. El tiempo de tramitación queda incorporado al calendario de obra antes de que empiece el derribo.' },
  ...
  'torrejon-de-ardoz': {
    ...
    body: [
      ...
      { type: 'p', text: 'La mayor parte de la vivienda residencial de Torrejón de Ardoz se construyó entre los años 70 y 90. En esos bloques, los baños pueden tener entre 4 y 5 metros cuadrados, bañera empotrada y alicatado de pieza de 20 por 25 centímetros que no se ha renovado desde la construcción. La fontanería, en muchos casos, tampoco se ha tocado.' },
  ...
  'coslada': {
    ...
    body: [
      ...
      { type: 'p', text: 'Al retirar el alicatado en estos baños, puede encontrarse humedad en el soporte, especialmente en las esquinas del suelo y en la base de las paredes. Si no se trata antes de colocar el nuevo revestimiento, la humedad reaparece en pocos meses. La impermeabilización de las zonas expuestas al agua va incluida en el presupuesto desde la primera partida, no como extra que aparece después de firmar.' },
  ...
  'san-fernando-de-henares': {
    ...
    body: [
      ...
      { type: 'p', text: 'En las urbanizaciones de Parque Roma y Parque Henares construidas en los años 90, las instalaciones pueden estar en mejor estado. En esos pisos, la reforma puede centrarse en cambiar el alicatado, los sanitarios y el mueble sin necesidad de renovar la fontanería de fondo. La diferencia de presupuesto entre los dos escenarios puede ser significativa, y la visita técnica lo aclara antes de comprometer cualquier número.' },
  ...
  'guadalajara': {
    intro: 'La reforma de baño en Guadalajara tiene dos puntos de partida muy distintos según si la vivienda está en el centro histórico o en los barrios de expansión de los años 2000. En el centro, la fontanería original puede llevar décadas sin tocarse. En la periferia más reciente, las instalaciones pueden estar en buen estado y la reforma puede centrarse en los acabados.',
    body: [
      { type: 'h3', text: 'El parque de baños en Guadalajara: centro histórico frente a expansión reciente' },
      { type: 'p', text: 'En Guadalajara capital existen dos tipos de parque residencial con condiciones muy distintas para una reforma de baño. En los edificios del centro histórico y en los construidos antes de los años 80, pueden encontrarse fontanería original con décadas de uso, baños de 3 a 4 metros cuadrados y soportes que pueden presentar humedades acumuladas no visibles desde fuera.' },
      { type: 'p', text: 'En los barrios de expansión construidos desde los años 90 en adelante, las instalaciones pueden estar en mejor estado y los baños son algo más amplios. Allí la reforma puede concentrarse en cambiar el alicatado, los sanitarios y el mueble sin necesidad de abrir la fontanería. Esta diferencia en el estado de partida es lo que más condiciona el presupuesto antes de elegir ningún material.' },
  ...
  'azuqueca-de-henares': {
    ...
    body: [
      ...
      { type: 'h3', text: 'Reformar baño y cocina al mismo tiempo en Azuqueca: por qué puede ser más eficiente' },
  ...
  'meco': {
    intro: 'La reforma de baño en Meco trabaja en adosados y viviendas unifamiliares. La distribución y la superficie de estas viviendas pueden dar lugar a opciones de diseño distintas a las de los pisos de bloque. Las posibilidades concretas de redistribución se valoran en visita antes de cerrar el alcance y el precio.',
    body: [
      { type: 'h3', text: 'Baños en adosados y unifamiliares de Meco: distribución y opciones según la visita' },
      { type: 'p', text: 'La mayoría de las viviendas en Meco son adosados y casas unifamiliares construidas entre los años 90 y los primeros años 2000. Según la distribución original y la superficie disponible, la reforma puede incluir ducha de obra, doble lavabo con encimera o separación de zonas. Lo que es viable en cada caso se determina en la visita técnica antes de comprometer ningún número.' },
  ...
  'camarma-de-esteruelas': {
    ...
    body: [
      ...
      { type: 'p', text: 'A diferencia de los bloques de los años 70 y 80, las instalaciones de estas viviendas pueden estar en buen estado; si no han dado problemas, la reforma puede centrarse en lo que más se nota: cambio completo del alicatado, sanitarios nuevos, mueble con mayor almacenaje y mampara de cristal templado sin perfilería visible.' },
...
export const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  'torrejon-de-ardoz': [
    ...
    {
      q: '¿Qué puede encontrarse al abrir los baños de los bloques de Torrejón de los años 80?',
      a: 'Puede encontrarse alicatado de pieza pequeña con la adherencia justa después de décadas de uso, fontanería de hierro galvanizado en las tuberías más antiguas y, en algunos casos, humedad en el soporte en las esquinas de suelo y pared. Al retirar el revestimiento se ve el estado real. Si hay algo no previsto, lo comunicamos antes de actuar y lo valoramos por separado antes de continuar.',
    },
  ],
  ...
  'san-fernando-de-henares': [
    {
      ...
      a: 'La diferencia puede ser relevante si uno de los baños necesita renovar la fontanería y el otro no. En el casco antiguo, las instalaciones pueden llevar décadas sin tocarse; en Parque Roma y Parque Henares, la fontanería puede estar en mejor estado. Cuando no hace falta renovar las instalaciones, el presupuesto de la reforma puede ser notablemente menor. La visita técnica determina el escenario real antes de cerrar ningún número.',
    },
    {
  ...
  'guadalajara': [
    ...
    },
    {
      ...
      a: 'Las mejoras recomendadas son: plato de ducha al nivel del suelo sin escalón, barra de apoyo abatible junto al inodoro y espacio libre lateral al inodoro para maniobra o apoyo. Añadirlas durante la reforma tiene un coste muy inferior a hacerlas en una obra posterior porque el baño ya está abierto. En la visita te mostramos qué opciones encajan con la distribución de tu baño concreto.',
    },
    {
  ...
  'camarma-de-esteruelas': [
    {
      q: '¿Qué materiales pueden sustituirse en los baños de las urbanizaciones de Camarma de 2000-2010?',
...
export const META: Record<string, string> = {
  'alcala-de-henares':      'Reforma de baño en Alcalá de Henares: evaluamos soporte e instalaciones en visita. Casco antiguo o barrios recientes. Precio cerrado. Desde 2.800€.',
  ...
  'coslada':                'Reforma de baño en Coslada: baños compactos con historial de humedad. Impermeabilización incluida desde el presupuesto. Precio cerrado. Desde 2.800€.',
  ...
  'guadalajara':            'Reforma de baño en Guadalajara: centro histórico o expansión reciente. Accesibilidad sin obra adicional. Permisos incluidos. Precio cerrado. Desde 2.800€.',
  'azuqueca-de-henares':    'Reforma de baño en Azuqueca de Henares: bloques 80-90 con instalaciones que aguantan. Acabados sin tocar fontanería. Precio cerrado. Desde 2.800€.',
  'meco':                   'Reforma de baño en Meco: adosados y unifamiliares con distintas opciones de distribución. Alcance según visita técnica. Precio cerrado. Desde 2.800€.',
