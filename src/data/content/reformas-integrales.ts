...
export const CONTENT: Record<string, { intro: string; body: { type: string; text: string; link?: { text: string; serviceSlug: string } }[] }> = {
  ...
  'alcala-de-henares': {
    ...
    body: [
      ...
      { type: 'p', text: 'En el Ensanche y el entorno de la calle Mayor de Alcalá, la vivienda predominante es de los años 70 y 80. En esos pisos, los cuadros eléctricos son frecuentemente de la marca Merlin Gerin de generación anterior, con capacidad insuficiente para el uso actual y sin diferencial independiente por circuito. La fontanería de hierro galvanizado, cuando no se ha tocado, presenta corrosión interior que reduce la sección de paso.' },
  ...
  'torrejon-de-ardoz': {
    ...
    body: [
      ...
      { type: 'p', text: 'En las urbanizaciones más recientes de Torrejón como Parque Europas o Soto del Henares, construidas en los años 90 y 2000, las instalaciones suelen estar en mejor estado. En esos casos, el presupuesto puede concentrarse en distribución y acabados con un alcance más acotado. La visita técnica determina el escenario real y el tipo de reforma que corresponde.' },
  ...
  'coslada': {
    ...
    body: [
      { type: 'h3', text: 'Primera reforma integral en vivienda social de Coslada: qué suele encontrarse' },
      ...
      { type: 'h3', text: 'Reforma integral por fases en Coslada: por qué suele ser menos eficiente' },
  ...
  'san-fernando-de-henares': {
    ...
    body: [
      ...
      { type: 'p', text: 'En las promociones de Parque Roma y Parque Henares, construidas en los años 90, las instalaciones suelen estar en mejor estado. En esos pisos, la reforma puede centrarse en distribución y acabados sin necesidad de renovar el cuadro eléctrico completo ni la fontanería de fondo. El alcance es menor y el presupuesto se ajusta a lo que realmente requiere la vivienda.' },
  ...
  'meco': {
    ...
    body: [
      ...
      { type: 'p', text: 'Las instalaciones en los adosados de Meco suelen ser independientes: caldera propia, acometida de agua directa, cuadro eléctrico con potencia suficiente. Eso da más libertad en el alcance de la reforma. En muchos de estos adosados de los años 90 y 2000, las instalaciones pueden aprovecharse parcial o totalmente, lo que deja más presupuesto disponible para distribución y acabados.' },
...
export const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  'alcala-de-henares': [
    ...
    {
      q: '¿Qué suele alargar más el plazo en las reformas integrales en Alcalá?',
