export const ZONE_FAQS: Record<string, { q: string; a: string }[]> = {
  'alcala-de-henares': [
    {
      ...
      a: 'Reformas integrales, reforma de baño, cocina, pisos y chalets, locales comerciales y obras en comunidades de propietarios. Cubrimos Alcalá de Henares con precio cerrado y plazo garantizado en contrato. La visita técnica gratuita evalúa el estado de la vivienda antes de comprometer ningún número.',
    },
    {
    ...
    },
    {
      ...
      a: 'Una reforma integral de piso de 80-90 m² con instalaciones, baño, cocina, suelos y pintura lleva entre 10 y 14 semanas en condiciones normales. Si la reforma es parcial (baño y cocina con instalaciones en buen estado), el plazo habitual es de 4-6 semanas. La fecha de entrega queda fijada en el contrato.',
    },
    {
      q: '¿Trabajáis también en chalets y adosados en Alcalá de Henares?',
      a: 'Sí. Reformas en vivienda unifamiliar y adosados en Alcalá, con el mismo proceso y sistema de precio cerrado. En vivienda de dos plantas el alcance puede incluir cubierta, terraza o escalera interior según el estado de la vivienda. La visita técnica evalúa el estado completo antes de presupuestar.',
    },
    {
  ...
  'torrejon-de-ardoz': [
    ...
    {
      q: '¿Cuánto cuesta una reforma de baño en Torrejón de Ardoz?',
      a: 'Una reforma de baño con ducha de obra, alicatado completo hasta el techo y sanitarios nuevos parte de 3.500-4.500€ en gama media. El precio depende de los metros y las partidas incluidas. La calculadora de precios del sitio da una orientación antes de la visita técnica gratuita.',
    },
    {
      q: '¿Cuánto tiempo tarda una reforma integral de piso en Torrejón de Ardoz?',
      a: 'Una reforma integral de 80-90 m² que incluye instalaciones, baño, cocina, suelos y pintura lleva entre 10 y 14 semanas según el alcance. Si la reforma es parcial, baño y cocina con instalaciones en buen estado pueden completarse en 4-6 semanas. La fecha de entrega queda fijada en el contrato antes de empezar.',
    },
    {
  ...
  'coslada': [
    ...
    {
      q: '¿Cuánto cuesta reformar un baño en Coslada?',
      a: 'Una reforma de baño con cambio de bañera por ducha de obra, alicatado hasta el techo, sanitarios nuevos y mueble de baño parte de 3.500-4.500€ en gama media, dependiendo de los metros y materiales elegidos. El precio exacto requiere medidas y ver el estado actual. La visita técnica es gratuita y sin compromiso.',
    },
    {
  ...
  'san-fernando-de-henares': [
    ...
    {
      q: '¿Cuándo conviene hacer toda la reforma a la vez en San Fernando en lugar de ir por fases?',
    ...
    {
      q: '¿Cuánto cuesta reformar un piso en San Fernando de Henares?',
      a: 'Depende del alcance y el estado de partida. Una reforma de baño parte de 3.500-4.500€ en gama media. Una reforma integral de piso de 80 m² con instalaciones puede estar entre 30.000 y 50.000€ según el estado de las instalaciones y los materiales elegidos. El presupuesto cerrado lo recibes tras la visita técnica gratuita.',
    },
    {
  ...
  'guadalajara': [
    ...
    {
      q: '¿Cuánto cuesta reformar un piso en Guadalajara?',
      a: 'El precio depende del alcance, la superficie y el estado de partida de las instalaciones. Una reforma integral de piso de 80-90 m² con instalaciones, baño, cocina, suelos y pintura en gama media parte de 35.000-50.000€. El primer paso para una cifra ajustada es la visita técnica gratuita, que evalúa el estado real antes de cerrar ningún número.',
    },
    {
      q: '¿Cuánto tiempo tarda una reforma integral en Guadalajara?',
      a: 'Una reforma integral de 80-90 m² con instalaciones completas lleva entre 10 y 14 semanas. Una reforma parcial de baño y cocina, con instalaciones en buen estado, puede completarse en 4-6 semanas. La fecha de entrega queda fijada en el contrato antes de empezar la obra.',
    },
    {
      q: '¿Qué diferencia hay entre reformar en el Balconcillo y en Aguas Vivas en Guadalajara?',
      a: 'Más que de barrio, depende de la época de construcción. El Balconcillo tiene más concentración de pisos de los años 70-80, donde las instalaciones suelen incluirse en el alcance de la reforma. En Aguas Vivas, con promociones de los años 90, las instalaciones suelen estar en mejor estado y el foco pasa a baño, cocina y acabados.',
    },
    {
  ...
  'camarma-de-esteruelas': [
    ...
    },
    {
      ...
      a: 'Sí. Reparación e impermeabilización de cubierta, combinada frecuentemente con mejora de carpintería exterior. En algunos casos forma parte de una reforma integral; en otros es una actuación independiente. El alcance lo determinamos en la visita técnica gratuita, que evalúa el estado del tejado además del interior.',
    },
  ],
};
