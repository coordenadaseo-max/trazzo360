...
export const SERVICES = [
  {
    ...
    body: [
      'Reformamos tu piso, ático o chalet de arriba a abajo en el Corredor del Henares. Gestionamos el proyecto completo: diseño, gestión de licencias, derribo de tabiques, instalaciones nuevas de electricidad y fontanería, suelos, baño, cocina, carpintería y pintura. Todo con precio cerrado en el contrato desde el primer día.',
      'Llevamos más de 10 años ejecutando reformas integrales en Alcalá de Henares, Torrejón de Ardoz, Coslada, San Fernando de Henares y todo el Corredor. Trabajamos con equipo propio —sin subcontratas— lo que nos permite controlar cada fase de la obra y cumplir los plazos de entrega.',
      'La reforma integral media en el Corredor del Henares parte de los 24.900€ para un piso de 70–90 m² con materiales de calidad media-alta. El precio incluye materiales, mano de obra, gestión de permisos y limpieza final.',
    ],
    priceFrom: '24.900',
  ...
  },
  {
    ...
    body: [
      'Reformamos tu baño completo en el Corredor del Henares con precio cerrado y entrega en 1–3 semanas. Nos encargamos de todo: cambio de bañera por ducha, alicatado nuevo, sanitarios, fontanería, mampara, muebles de baño e iluminación. Sin sorpresas en el precio final.',
      'El servicio más solicitado en los municipios del Corredor es el cambio de bañera por plato de ducha, especialmente en viviendas de los años 70–90 donde los baños tienen bañeras antiguas y alicatados deteriorados. También realizamos reformas completas de baño principal y aseo desde cero.',
      'Incluimos siempre impermeabilización de suelo y paredes, suministro y colocación de todos los materiales, gestión de escombros y limpieza final.',
    ],
    priceFrom: '3.200',
  ...
  },
  {
    ...
    body: [
      'Reformamos tu cocina de principio a fin en el Corredor del Henares: muebles a medida o de catálogo, encimeras de silestone, porcelana o madera, electrodomésticos integrados, fontanería, electricidad, alicatado y pintura. Todo incluido, precio cerrado.',
      'Diseñamos cocinas en L, U, galería, americana o con isla según las dimensiones de tu espacio. Trabajamos con los principales fabricantes de muebles de cocina de calidad media-alta y gestionamos todo el proceso, desde el plano inicial hasta la instalación de los últimos detalles.',
      'El plazo habitual de una reforma completa de cocina en el Corredor del Henares es de 2 a 4 semanas dependiendo del alcance y los materiales seleccionados.',
    ],
    priceFrom: '5.500',
  ...
  },
  {
    ...
    body: [
      'Reformamos pisos y chalets en el Corredor del Henares con precio cerrado y plazo garantizado. Realizamos redistribución de espacios mediante derribo y levantamiento de tabiques, instalaciones nuevas de electricidad y fontanería, suelos de porcelánico o tarima, ventanas, carpintería interior y pintura.',
      'Es el servicio más habitual entre propietarios de viviendas de los años 70–90 en municipios como Alcalá de Henares, Torrejón de Ardoz y Coslada que quieren actualizar distribuciones anticuadas, modernizar los acabados o preparar el piso para su venta o alquiler.',
      'Presupuestamos la reforma completa o parcial según lo que necesites. Si tu presupuesto es de 20.000–30.000€ podemos diseñar un plan que incluya suelos nuevos, renovación de baño, pintura y carpintería, maximizando el resultado dentro del presupuesto disponible.',
    ],
    priceFrom: '18.000',
  ...
  },
  {
    ...
    body: [
      'Transformamos locales vacíos en espacios comerciales, de oficinas o de hostelería en el Corredor del Henares. Nos encargamos de todo: proyecto técnico, tramitación de la licencia de actividad, instalaciones eléctricas y de fontanería, divisiones de pladur, suelos, techos, pintura, carpintería y entrega llave en mano.',
      'Cuando tienes un negocio que depende de abrir en una fecha concreta, el plazo de obra no es negociable. Por eso fijamos la fecha de entrega en el contrato y la cumplimos. Hemos reformado locales comerciales, restaurantes, oficinas, clínicas y peluquerías en todo el Corredor del Henares.',
      'Emitimos presupuesto detallado con partidas separadas para que puedas planificar la inversión y gestionar las deducciones fiscales correspondientes.',
    ],
    priceFrom: '8.000',
  ...
  },
  {
    ...
    body: [
      'Realizamos obras de mantenimiento y reforma en zonas comunes de comunidades de vecinos en el Corredor del Henares: portales, escaleras, fachadas, cubiertas, instalaciones comunitarias, impermeabilización y accesibilidad. Emitimos presupuesto detallado con memorias técnicas para presentar en junta de propietarios.',
      'Coordinamos directamente con el administrador de fincas y adaptamos los horarios de obra para minimizar las molestias a los vecinos. Trabajamos con todas las aseguradoras y gestionamos los expedientes de siniestros cuando la obra tiene cobertura de seguro comunitario.',
      'Disponemos de experiencia en comunidades de vecinos de todos los tamaños, desde portales de 6 viviendas hasta urbanizaciones con más de 200 unidades en municipios del Corredor del Henares como Alcalá de Henares, Torrejón de Ardoz, Coslada y San Fernando de Henares.',
    ],
    priceFrom: '4.900',
